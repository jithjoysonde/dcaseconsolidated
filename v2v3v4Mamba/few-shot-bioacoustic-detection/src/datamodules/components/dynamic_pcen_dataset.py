...
from src.datamodules.components.augmentations import AugmentationPipeline


class PrototypeDynamicArrayDataSet(Dataset):
    def __init__(self, path: dict = {}, features: dict = {}, train_param: dict = {}, augmentation_config: dict = None):
        """_summary_
        ...
        Args:
            ...
            augmentation_config (dict, optional): Augmentation settings. Defaults to None.
        """
        self.path = path
        ...
        if augmentation_config is not None:
            self.augmentation = AugmentationPipeline(augmentation_config)
        else:
